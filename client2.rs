...
lazy_static! {
    ...
    //send, receive
    static ref SND_SERVER_SOCKET: SocketAddr= "127.0.0.0:8001".parse().unwrap();
    static ref RCV_SERVER_SOCKET: SocketAddr= "127.0.0.0:9001".parse().unwrap();
    static ref RCV_SERVER_SOCKET_2: SocketAddr= "127.0.0.0:7001".parse().unwrap();
    static ref SND_CLIENT_SOCKET: SocketAddr= "127.0.0.0:5001".parse().unwrap();
    static ref RCV_CLIENT_SOCKET: SocketAddr= "127.0.0.0:6001".parse().unwrap();
